...
export default function Intro({ onComplete }) {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full h-screen fixed bg-gradient-to-b from-indigo-50 to-white dark:from-gray-900 dark:to-black flex flex-col justify-center items-center transition-colors duration-300"
      role="region"
      ...
      <div className="title flex justify-center items-center space-x-1 sm:space-x-2">
        {["W", "a", "l", "l", "o", "r", "y"].map((letter, index) => (
          <span
            ...
            className="font-['Leckerli_One',_cursive] text-4xl sm:text-6xl lg:text-8xl text-indigo-600 dark:text-indigo-400"
          >
            {letter}
          </span>
        ))}

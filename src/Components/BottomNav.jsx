      ...
      <ul className="flex justify-evenly items-center">
        <li className="bottom-nav-icon py-[5px] px-[2.5vw]">
          <NavLink to="/" className="cursor-default sm:cursor-pointer">
            {activeNav === "home" ? (
              <GoHomeFill className="text-[#ffffff] w-12 h-12 dark:hover:bg-gray-800 rounded-full px-2 py-2 hover:bg-indigo-400" />
            ) : (
              <GoHome className="text-[#ffffff] w-12 h-12 dark:hover:bg-gray-800 rounded-full px-2 py-2 hover:bg-indigo-400" />
            )}
          </NavLink>
        </li>
        <li className="bottom-nav-icon py-[5px] px-[2.5vw]">
          <NavLink to="/explore" className="cursor-default sm:cursor-pointer">
            {activeNav === "explore" ? (
              <RiSearchFill className="text-[#ffffff] w-12 h-12 dark:hover:bg-gray-800 rounded-full px-2 py-2 hover:bg-indigo-400" />
            ) : (
              <RiSearchLine className="text-[#ffffff] w-12 h-12 dark:hover:bg-gray-800 rounded-full px-2 py-2 hover:bg-indigo-400" />
            )}
          </NavLink>
        </li>
        <li className="bottom-nav-icon py-[5px] px-[2.5vw]">
          <DarkModeSwitch
            ...
            className="darkmode-cursor hover:bg-indigo-400 dark:hover:bg-gray-800 rounded-full px-2 py-2"
            sunColor="white"
            moonColor="white"
            size={48}
